export default class GraphModal {
  ...
  close() {
    if (this.modalContainer) {
      ...
      // Убираем инлайновый стиль scroll-behavior
      ["body", "documentElement"].forEach((el) => {
        document[el].style.removeProperty("scroll-behavior");

        // Если инлайновый стиль пуст, убираем атрибут style
        if (!document[el].getAttribute("style")) {
          document[el].removeAttribute("style");
        }
      });
